<script lang="ts">
	...
	const modules = [
		{ id: 'fms', title: 'Fleet Management', subtitle: 'FMS • GPS & Drivers', icon: 'precision_manufacturing', colorClass: 'bg-blue-50', textClass: 'text-blue-600' },
		{ id: 'maintenance', title: 'Workshop & Maintenance', subtitle: 'Work Orders & Repairs', icon: 'build_circle', colorClass: 'bg-slate-100', textClass: 'text-slate-700' },
		{ id: 'ocs', title: 'Operations Control', subtitle: 'OCS • Dispatch & Targets', icon: 'hub', colorClass: 'bg-sky-50', textClass: 'text-sky-600' },
		{ id: 'hris', title: 'Human Capital', subtitle: 'HRIS • Payroll & HR', icon: 'groups', colorClass: 'bg-purple-50', textClass: 'text-purple-600' },
		{ id: 'marketing', title: 'Marketing & Contracts', subtitle: 'Sales & Agreements', icon: 'campaign', colorClass: 'bg-rose-50', textClass: 'text-rose-600' },
		{ id: 'pms', title: 'Procurement', subtitle: 'PMS • PR, PO & Vendors', icon: 'inventory', colorClass: 'bg-amber-50', textClass: 'text-amber-600' },
